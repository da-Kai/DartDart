...
const _masterCheckoutCsv = 'assets/data/checkout-master.csv';
const _doubleCheckoutCsv = 'assets/data/checkout-double.csv';
...
String _find(String asset, String pattern) {
...
Checkout calcCheckout(InOut setting, int score) {
  if (score == 0 || setting.highestCheckout() < score || setting == InOut.straight) {
    return Checkout();
  }
  ...
  if (setting == InOut.master) {
    line = _find(_masterCheckoutCsv, find);
  }
  if (line == '') {
    line = _find(_doubleCheckoutCsv, find);
  }

  return _convert(line);
}

String data = """170;T20;T20;DBULL
167;T20;T19;DBULL
164;T20;T18;DBULL
161;T20;T17;DBULL
160;T20;T20;D20
